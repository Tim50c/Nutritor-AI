...
function BaseText(props: CustomTextProps) {
  ...
  const getFontFamily = () => {
    ...
    const weight = isBoldFromClassName
      ? "bold"
  ...
  const textStyle = {
    ...
    // Default to semantic color unless overridden
    ...(className?.match(/text-/) ? {} : { color: "#111214" }),
  };
  ...
  return (
    <RNText
      ...
      className={
        className
          ? `${className} text-default dark:text-default-dark`
